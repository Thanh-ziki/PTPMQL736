...
namespace PTPMBTL.Controllers
{
    public class KhachHangController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IDKhachHang,TenKH,DiaChi,SoBan")] KhachHang khachHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("IDKhachHang,TenKH,DiaChi,SoBan")] KhachHang khachHang)
        {
        ...
        {
          return (_context.KhachHang?.Any(e => e.IDKhachHang == id)).GetValueOrDefault();
        }
    }
}
